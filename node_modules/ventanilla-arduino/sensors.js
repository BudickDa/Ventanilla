...
initFunctions.LD35 = function(sensor){
  var LD35 = new five.Sensor(sensor.hardware);
  LD35.uid = sensor.uid;
...
exports.registerSensor = function(hardware,interface,sensor,cb){
  if(initFunctions[sensor.name]!==undefined){
    hardware.arduinoBoards[interface.uid].sensors[sensor.uid] = initFunctions[sensor.name](sensor);
